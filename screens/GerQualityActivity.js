...
export default class QualityActivity extends React.Component {
                  ...
                  if (clippingOption3) {
                    if (clippingOption4) {
                      if (this.state.isItConnected === 'Online') {
                        ...
                        const url = `${scriptUrl}?
                                                callback=ctrlq&action=${'doPostGer'}&week_number=${
                          that.state.weekNumber
                        }&auditor_name=${that.state.auditorsName}&job=${
                          that.state.jobSelected
                        }&house_number=${that.state.houseNumber}&row_number=${
  ...
  navigateToScreen = () => {
    this.props.navigation.navigate('NameJobSelectorGer', {
          ...
          <View
            ...
            <DropDownPicker
              items={[
                ...
                {label: 'Vikash Chand', value: 'Vikash Chand'},
                {label: 'Tevita Fetuani', value: 'Tevita Fetuani'},
                {label: 'Simione Filiai', value: 'Simione Filiai'},
                {label: 'Nau Pesa', value: 'Nau Pesa'},
                {label: 'Sai Chandrasekar', value: 'Sai Chandrasekar'},
                {
                  label: 'Brooklyn Keown Wohnsiedler',
                  value: 'Brooklyn Keown Wohnsiedler',
                },
              ]}
              placeholder="SELECT"
