...
export default class NameJobSelectorFav extends React.Component {
    ...
    handleConnectivityChange = state => {
        if (state.isConnected) {
            ...
            const scriptUrl1 = 'https://script.google.com/macros/s/AKfycbyEIgoKp--jFqtN7tUB1p-zjAsZwEj1mulA4GkRRpWgippxOIU/exec';
            const url1 = `${scriptUrl1}?callback=ctrlq&action=${'doGetFavData'}`;
