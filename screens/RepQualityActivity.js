...
export default class RepQualityActivity extends React.Component {
  ...
  componentDidMount() {
    ...
    try {
      AsyncStorage.getItem('auditorsName')
        .then((name) => {
    ...
    try {
      AsyncStorage.getItem('rowNumber')
        .then((row) => {
  ...
  changeActiveRadioTrussPickingButton1(index) {
    ...
    this.setState(
      {radioTrussPickingItems1: this.state.radioTrussPickingItems1},
      () => {
        this.setState({
          trussPickingOption1: this.state.radioTrussPickingItems1[index].label,
        });
      },
    );
  }
  ...
  changeActiveRadioTrussPickingButton2(index) {
    ...
    this.setState(
      {radioTrussPickingItems2: this.state.radioTrussPickingItems2},
      () => {
        this.setState({
          trussPickingOption2: this.state.radioTrussPickingItems2[index].label,
        });
      },
    );
  }
  ...
  changeActiveRadioTrussPickingButton3(index) {
    ...
    this.setState(
      {radioTrussPickingItems3: this.state.radioTrussPickingItems3},
      () => {
        this.setState({
          trussPickingOption3: this.state.radioTrussPickingItems3[index].label,
        });
      },
    );
  }
  ...
  changeActiveRadioTrussPickingButton4(index) {
    ...
    this.setState(
      {radioTrussPickingItems4: this.state.radioTrussPickingItems4},
      () => {
        this.setState({
          trussPickingOption4: this.state.radioTrussPickingItems4[index].label,
        });
      },
    );
  }
  ...
  changeActiveRadioClipPruneButton1(index) {
    ...
    this.setState(
      {radioClipPruneItems1: this.state.radioClipPruneItems1},
      () => {
        this.setState({
          clipPruneOption1: this.state.radioClipPruneItems1[index].label,
        });
      },
    );
  }
  ...
  changeActiveRadioClipPruneButton2(index) {
    ...
    this.setState(
      {radioClipPruneItems2: this.state.radioClipPruneItems2},
      () => {
        this.setState({
          clipPruneOption2: this.state.radioClipPruneItems2[index].label,
        });
      },
    );
  }
  ...
  changeActiveRadioClipPruneButton3(index) {
    ...
    this.setState(
      {radioClipPruneItems3: this.state.radioClipPruneItems3},
      () => {
        this.setState({
          clipPruneOption3: this.state.radioClipPruneItems3[index].label,
        });
      },
    );
  }
  ...
  changeActiveRadioClipPruneButton4(index) {
    ...
    this.setState(
      {radioClipPruneItems4: this.state.radioClipPruneItems4},
      () => {
        this.setState({
          clipPruneOption4: this.state.radioClipPruneItems4[index].label,
        });
      },
    );
  }
  ...
  changeActiveRadioClipPruneButton5(index) {
    ...
    this.setState(
      {radioClipPruneItems5: this.state.radioClipPruneItems5},
      () => {
        this.setState({
          clipPruneOption5: this.state.radioClipPruneItems5[index].label,
        });
      },
    );
  }
  ...
  changeActiveRadioClipPruneButton6(index) {
    ...
    this.setState(
      {radioClipPruneItems6: this.state.radioClipPruneItems6},
      () => {
        this.setState({
          clipPruneOption6: this.state.radioClipPruneItems6[index].label,
        });
      },
    );
  }
  ...
  changeActiveRadioClipPruneButton7(index) {
    ...
    this.setState(
      {radioClipPruneItems7: this.state.radioClipPruneItems7},
      () => {
        this.setState({
          clipPruneOption7: this.state.radioClipPruneItems7[index].label,
        });
      },
    );
  }
  ...
  changeActiveRadioClipPruneButton8(index) {
    ...
    this.setState(
      {radioClipPruneItems8: this.state.radioClipPruneItems8},
      () => {
        this.setState({
          clipPruneOption8: this.state.radioClipPruneItems8[index].label,
        });
      },
    );
  }
  ...
  resetClipPruneRadioButton = () => {
    ...
    this.setState(
      ...
      () => {
        this.setState({
          clipPruneOption1: this.state.radioClipPruneItems1[0].label,
        });
      },
    );
    //END
    ...
    this.setState(
      ...
      () => {
        this.setState({
          clipPruneOption2: this.state.radioClipPruneItems2[0].label,
        });
      },
    );
    //END
    ...
    this.setState(
      ...
      () => {
        this.setState({
          clipPruneOption3: this.state.radioClipPruneItems3[0].label,
        });
      },
    );
    //END
    ...
    this.setState(
      ...
      () => {
        this.setState({
          clipPruneOption4: this.state.radioClipPruneItems4[0].label,
        });
      },
    );
    //END
    ...
    this.setState(
      ...
      () => {
        this.setState({
          clipPruneOption5: this.state.radioClipPruneItems5[0].label,
        });
      },
    );
    //END
    ...
    this.setState(
      ...
      () => {
        this.setState({
          clipPruneOption6: this.state.radioClipPruneItems6[0].label,
        });
      },
    );
    //END
    ...
    this.setState(
      ...
      () => {
        this.setState({
          clipPruneOption7: this.state.radioClipPruneItems7[0].label,
        });
      },
    );
    //END
    ...
    this.setState(
      ...
      () => {
        this.setState({
          clipPruneOption8: this.state.radioClipPruneItems8[0].label,
        });
      },
    );
    //END
  ...
  resetTrussPickingRadioButton = () => {
    ...
    this.setState(
      ...
      () => {
        this.setState({
          trussPickingOption1: this.state.radioTrussPickingItems1[0].label,
        });
      },
    );
    //END
    ...
    this.setState(
      ...
      () => {
        this.setState({
          trussPickingOption2: this.state.radioTrussPickingItems2[0].label,
        });
      },
    );
    //END
    ...
    this.setState(
      ...
      () => {
        this.setState({
          trussPickingOption3: this.state.radioTrussPickingItems3[0].label,
        });
      },
    );
    //END
    ...
    this.setState(
      ...
      () => {
        this.setState({
          trussPickingOption4: this.state.radioTrussPickingItems4[0].label,
        });
      },
    );
    //END
  ...
  calculateClipPruneQualityPercentage = () => {
    setTimeout(() => {
                  ...
                  if (clippingOption3) {
                    if (clippingOption4) {
                      if (this.state.isItConnected === 'Online') {
                        ...
                        const scriptUrl =
                          'https://script.google.com/macros/s/AKfycbywdq90H8X6CVYR2Vlla9rkRAPdsYmMTmO-sKfqsOmf7BGGNj0p_g4y/exec';
                        const url = `${scriptUrl}?
                                                callback=ctrlq&action=${'doPostRepSite'}&week_number=${
                          ...
                          that.state.adiCode
                        }&data1=${that.state.clippingOption1}&data2=${
                          that.state.clippingOption2
                        }&data3=${that.state.clippingOption3}&data4=${
                          that.state.clippingOption4
                    ...
                    if (archingOption4) {
                      if (this.state.isItConnected === 'Online') {
                        ...
                        const url = `${scriptUrl}?
                          ...
                          that.state.adiCode
                        }&data1=${that.state.archingOption1}&data2=${
                          that.state.archingOption2
                        }&data3=${that.state.archingOption3}&data4=${
                          that.state.archingOption4
                        }&data5=${''}&data6=${''}&data7=${''}&data8=${''}&comments=${
                          that.state.comments
                        }&quality_percent=${that.state.qualityPercentage}`;
                    ...
                    if (trussPickingOption4) {
                      if (this.state.isItConnected === 'Online') {
                        ...
                        const url = `${scriptUrl}?
                          ...
                          that.state.adiCode
                        }&data1=${that.state.trussPickingOption1}&data2=${
                          that.state.trussPickingOption2
                        }&data3=${that.state.trussPickingOption3}&data4=${
                          that.state.trussPickingOption4
                        }&data5=${''}&data6=${''}&data7=${''}&data8=${''}&comments=${
                          that.state.comments
                        }&quality_percent=${that.state.qualityPercentage}`;
                      ...
                      this.setState({isLoading: false});
                      alert(
                        'Choose one option from truss picking quality check 4',
                      );
                    }
                  } else {
                    this.setState({isLoading: false});
                    alert(
                      'Choose one option from truss picking quality check 3',
                    );
                  }
                } else {
                  this.setState({isLoading: false});
                    ...
                    if (pruningOption4) {
                      if (this.state.isItConnected === 'Online') {
                        ...
                        const url = `${scriptUrl}?
                          ...
                          that.state.adiCode
                        }&data1=${that.state.pruningOption1}&data2=${
                          that.state.pruningOption2
                        }&data3=${that.state.pruningOption3}&data4=${
                          that.state.pruningOption4
                        }&data5=${''}&data6=${''}&data7=${''}&data8=${''}&comments=${
                          that.state.comments
                        }&quality_percent=${that.state.qualityPercentage}`;
                    ...
                    if (twistingOption4) {
                      if (this.state.isItConnected === 'Online') {
                        ...
                        const url = `${scriptUrl}?
                          ...
                          that.state.adiCode
                        }&data1=${that.state.twistingOption1}&data2=${
                          that.state.twistingOption2
                        }&data3=${that.state.twistingOption3}&data4=${
                          that.state.twistingOption4
                        }&data5=${''}&data6=${''}&data7=${''}&data8=${''}&comments=${
                          that.state.comments
                        }&quality_percent=${that.state.qualityPercentage}`;
                    ...
                    if (pickingOption4) {
                      if (this.state.isItConnected === 'Online') {
                        ...
                        const url = `${scriptUrl}?
                          ...
                          that.state.adiCode
                        }&data1=${that.state.pickingOption1}&data2=${
                          that.state.pickingOption2
                        }&data3=${that.state.pickingOption3}&data4=${
                          that.state.pickingOption4
                        }&data5=${''}&data6=${''}&data7=${''}&data8=${''}&comments=${
                          that.state.comments
                        }&quality_percent=${that.state.qualityPercentage}`;
                    ...
                    if (deleafingOption4) {
                      if (this.state.isItConnected === 'Online') {
                        ...
                        const url = `${scriptUrl}?
                          ...
                          that.state.adiCode
                        }&data1=${that.state.deleafingOption1}&data2=${
                          that.state.deleafingOption2
                        }&data3=${that.state.deleafingOption3}&data4=${
                          that.state.deleafingOption4
                        }&data5=${''}&data6=${''}&data7=${''}&data8=${''}&comments=${
                          that.state.comments
                        }&quality_percent=${that.state.qualityPercentage}`;
                            ...
                            if (clipPruneOption8) {
                              if (this.state.isItConnected === 'Online') {
                                ...
                                const url = `${scriptUrl}?
                                  ...
                                  that.state.clipPruneOption1
                                }&data2=${that.state.clipPruneOption2}&data3=${
                                  that.state.clipPruneOption3
                                }&data4=${that.state.clipPruneOption4}&data5=${
                                  that.state.clipPruneOption5
                                }&data6=${that.state.clipPruneOption6}&data7=${
                                  that.state.clipPruneOption7
                                }&data8=${
                                  that.state.clipPruneOption8
                                }&comments=${
                                  that.state.comments
                                }&quality_percent=${
                                  that.state.qualityPercentage
                              ...
                              this.setState({isLoading: false});
                              alert(
                                'Choose one option from clipping and pruning quality check 8',
                              );
                            }
                          } else {
                            this.setState({isLoading: false});
                            alert(
                              'Choose one option from clipping and pruning quality check 7',
                            );
                          }
                        } else {
                          this.setState({isLoading: false});
                          alert(
                            'Choose one option from clipping and pruning quality check 6',
                          );
                        }
                      } else {
                        this.setState({isLoading: false});
                        alert(
                          'Choose one option from clipping and pruning quality check 5',
                        );
                      }
                    } else {
                      this.setState({isLoading: false});
                      alert(
                        'Choose one option from clipping and pruning quality check 4',
                      );
                    }
                  } else {
                    this.setState({isLoading: false});
                    alert(
                      'Choose one option from clipping and pruning quality check 3',
                    );
                  }
                } else {
                  this.setState({isLoading: false});
                  alert(
                    'Choose one option from clipping and pruning quality check 2',
                  );
                }
              } else {
                this.setState({isLoading: false});
                alert(
                  'Choose one option from clipping and pruning quality check 1',
                );
              }
            } else {
              this.setState({isLoading: false});
                    ...
                    if (droppingOption4) {
                      if (this.state.isItConnected === 'Online') {
                        ...
                        const url = `${scriptUrl}?
                          ...
                          that.state.adiCode
                        }&data1=${that.state.droppingOption1}&data2=${
                          that.state.droppingOption2
                        }&data3=${that.state.droppingOption3}&data4=${
                          that.state.droppingOption4
                        }&data5=${''}&data6=${''}&data7=${''}&data8=${''}&comments=${
                          that.state.comments
                        }&quality_percent=${that.state.qualityPercentage}`;
  ...
  navigateToScreen = () => {
    this.props.navigation.navigate('NameJobSelectorRep', {
      name: this.state.auditorsName,
    });
  };
        ...
        <ScrollView
          ...
          <View
            ...
            <DropDownPicker
              items={[
                ...
                {label: 'Desiree Lloydd', value: 'Desiree Lloydd'},
              ]}
              placeholder="SELECT"
              ...
              onChangeItem={(item) =>
                this.updateTextInput(item.value, 'auditorsName')
              }
          ...
          {Platform.OS === 'ios' ? (
            <View style={styles.borderEdit}>
              {this.state.auditorsName !== null ? (
                <TouchableOpacity
                  style={styles.buttonContainerTextInput}
          ...
          {this.state.isScoreSet ? (
            <Text style={styles.scoreText}>
              Average 4 weeks score :{' '}
              <Text style={styles.redTextColor}>{this.state.avgScore}%</Text>
            </Text>
          ) : null}
          ...
          {this.state.jobSelected === 'Clipping' ? (
            <View>
              ...
              <Text style={styles.titleHeading2Text}>
                4) Laterals: take laterals from previous clip to the head, fail
              ...
              <View style={styles.flexDirection}>
                {this.state.radioPruningItems1.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioPruningButton1.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioPruningItems2.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioPruningButton2.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioPruningItems3.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioPruningButton3.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioPruningItems4.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioPruningButton4.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioTrussPickingItems1.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioTrussPickingButton1.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioTrussPickingItems2.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioTrussPickingButton2.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioTrussPickingItems3.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioTrussPickingButton3.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioTrussPickingItems4.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioTrussPickingButton4.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioArchingItems1.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioArchingButton1.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioArchingItems2.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioArchingButton2.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioArchingItems3.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioArchingButton3.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioArchingItems4.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioArchingButton4.bind(
                      this,
                      key,
                    )}
                  />
          ...
          {this.state.jobSelected === 'Twisting' ? (
            <View>
              ...
              <Text style={styles.titleHeading2Text}>
                5) Comments {'\n'}eg: 10 broken heads, twisting the wrong way,
                needs training, trusses cught under string (Select comment if
                needed){' '}
              </Text>
          ...
          {this.state.jobSelected === 'Clip And Prune' ? (
            <View>
              ...
              <View style={styles.flexDirection}>
                {this.state.radioClipPruneItems1.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioClipPruneButton1.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioClipPruneItems2.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioClipPruneButton2.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioClipPruneItems3.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioClipPruneButton3.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioClipPruneItems4.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioClipPruneButton4.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <Text style={styles.titleHeading2Text}>
                5)Clip position: not above a truss/one clip between truss/half
                twist <Text style={styles.redColor}>(0)</Text>{' '}
              </Text>
              ...
              <View style={styles.flexDirection}>
                {this.state.radioClipPruneItems5.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioClipPruneButton5.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioClipPruneItems6.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioClipPruneButton6.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <Text style={styles.titleHeading2Text}>
                7) Broken heads replaced and bobbin hung{' '}
                <Text style={styles.redColor}>(0)</Text>{' '}
              </Text>
              ...
              <View style={styles.flexDirection}>
                {this.state.radioClipPruneItems7.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioClipPruneButton7.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <Text style={styles.titleHeading2Text}>
                8) Laterals: take laterals from previous clip to the head, fail
                if larger than finger nail{' '}
                <Text style={styles.redColor}>(3 each)</Text>{' '}
              </Text>
              ...
              <View style={styles.flexDirection}>
                {this.state.radioClipPruneItems8.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioClipPruneButton8.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View
                ...
                <TouchableOpacity
                  style={styles.buttonContainer}
                  onPress={this.calculateClipPruneQualityPercentage}>
                  <Text style={styles.buttonText1}>Submit</Text>
                </TouchableOpacity>
              </View>
            </View>
              ...
              <View style={styles.flexDirection}>
                {this.state.radioPickingItems1.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioPickingButton1.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioPickingItems2.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioPickingButton2.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioPickingItems3.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioPickingButton3.bind(
                      this,
                      key,
                    )}
                  />
              ...
              <View style={styles.flexDirection}>
                {this.state.radioPickingItems4.map((item, key) => (
                  <RadioButton
                    key={key}
                    button={item}
                    onClick={this.changeActiveRadioPickingButton4.bind(
                      this,
                      key,
                    )}
                  />
          ...
          {this.state.jobSelected === 'Deleafing' ? (
            <View>
              ...
              <Text style={styles.titleHeading2Text}>
                5) Comments {'\n'}eg: sent back to fix stubs, sliced through a
                stem, string not cut (Select comment if needed){' '}
              </Text>
          ...
          {this.state.jobSelected === 'Dropping' ? (
            <View>
              ...
              <Text style={styles.titleHeading2Text}>
                5) Comments {'\n'}eg: vines are braided and bunchy but heads are
                levelled well, turning at the fronts/ backs needs improvement
                (Select comment if needed){' '}
              </Text>
