...
export default class RepQualityActivity extends React.Component {
                                    ...
                                    if (clippingOption3) {
                                        if (clippingOption4) {
                                            ...
                                            if (this.state.isItConnected === 'Online') {
                                                ...
                                                const url = `${scriptUrl}?
                                                callback=ctrlq&action=${'doPostRepSite'}&week_number=${that.state.weekNumber}&auditor_name=${that.state.auditorsName}&job=${that.state.jobSelected}&house_number=${that.state.houseNumber}&row_number=${that.state.rowNumber}&worker_name=${that.state.workersName}&adi_code=${that.state.adiCode}&data1=${that.state.clippingOption1}&data2=${that.state.clippingOption2}&data3=${that.state.clippingOption3}&data4=${that.state.clippingOption4}&data5=${''}&data6=${''}&data7=${''}&data8=${''}&comments=${that.state.comments}&quality_percent=${that.state.qualityPercentage}`;
                                    ...
                                    if (pruningOption3) {
                                        if (pruningOption4) {
                                            ...
                                            if (this.state.isItConnected === 'Online') {
                                                ...
                                                const scriptUrl = 'https://script.google.com/macros/s/AKfycbywdq90H8X6CVYR2Vlla9rkRAPdsYmMTmO-sKfqsOmf7BGGNj0p_g4y/exec';
                                                const url = `${scriptUrl}?
                                                callback=ctrlq&action=${'doPostRepSite'}&week_number=${that.state.weekNumber}&auditor_name=${that.state.auditorsName}&job=${that.state.jobSelected}&house_number=${that.state.houseNumber}&row_number=${that.state.rowNumber}&worker_name=${that.state.workersName}&adi_code=${that.state.adiCode}&data1=${that.state.pruningOption1}&data2=${that.state.pruningOption2}&data3=${that.state.pruningOption3}&data4=${that.state.pruningOption4}&data5=${''}&data6=${''}&data7=${''}&data8=${''}&comments=${that.state.comments}&quality_percent=${that.state.qualityPercentage}`;
                                    ...
                                    if (twistingOption3) {
                                        if (twistingOption4) {
                                            ...
                                            if (this.state.isItConnected === 'Online') {
                                                ...
                                                const scriptUrl = 'https://script.google.com/macros/s/AKfycbywdq90H8X6CVYR2Vlla9rkRAPdsYmMTmO-sKfqsOmf7BGGNj0p_g4y/exec';
                                                const url = `${scriptUrl}?
                                                callback=ctrlq&action=${'doPostRepSite'}&week_number=${that.state.weekNumber}&auditor_name=${that.state.auditorsName}&job=${that.state.jobSelected}&house_number=${that.state.houseNumber}&row_number=${that.state.rowNumber}&worker_name=${that.state.workersName}&adi_code=${that.state.adiCode}&data1=${that.state.twistingOption1}&data2=${that.state.twistingOption2}&data3=${that.state.twistingOption3}&data4=${that.state.twistingOption4}&data5=${''}&data6=${''}&data7=${''}&data8=${''}&comments=${that.state.comments}&quality_percent=${that.state.qualityPercentage}`;
                                    ...
                                    if (pickingOption3) {
                                        if (pickingOption4) {
                                            ...
                                            if (this.state.isItConnected === 'Online') {
                                                ...
                                                const scriptUrl = 'https://script.google.com/macros/s/AKfycbywdq90H8X6CVYR2Vlla9rkRAPdsYmMTmO-sKfqsOmf7BGGNj0p_g4y/exec';
                                                const url = `${scriptUrl}?
                                                callback=ctrlq&action=${'doPostRepSite'}&week_number=${that.state.weekNumber}&auditor_name=${that.state.auditorsName}&job=${that.state.jobSelected}&house_number=${that.state.houseNumber}&row_number=${that.state.rowNumber}&worker_name=${that.state.workersName}&adi_code=${that.state.adiCode}&data1=${that.state.pickingOption1}&data2=${that.state.pickingOption2}&data3=${that.state.pickingOption3}&data4=${that.state.pickingOption4}&data5=${''}&data6=${''}&data7=${''}&data8=${''}&comments=${that.state.comments}&quality_percent=${that.state.qualityPercentage}`;
                                    ...
                                    if (deleafingOption3) {
                                        if (deleafingOption4) {
                                            ...
                                            if (this.state.isItConnected === 'Online') {
                                                ...
                                                const scriptUrl = 'https://script.google.com/macros/s/AKfycbywdq90H8X6CVYR2Vlla9rkRAPdsYmMTmO-sKfqsOmf7BGGNj0p_g4y/exec';
                                                const url = `${scriptUrl}?
                                                callback=ctrlq&action=${'doPostRepSite'}&week_number=${that.state.weekNumber}&auditor_name=${that.state.auditorsName}&job=${that.state.jobSelected}&house_number=${that.state.houseNumber}&row_number=${that.state.rowNumber}&worker_name=${that.state.workersName}&adi_code=${that.state.adiCode}&data1=${that.state.deleafingOption1}&data2=${that.state.deleafingOption2}&data3=${that.state.deleafingOption3}&data4=${that.state.deleafingOption4}&data5=${''}&data6=${''}&data7=${''}&data8=${''}&comments=${that.state.comments}&quality_percent=${that.state.qualityPercentage}`;
                                    ...
                                    if (droppingOption3) {
                                        if (droppingOption4) {
                                            ...
                                            if (this.state.isItConnected === 'Online') {
                                                ...
                                                const scriptUrl = 'https://script.google.com/macros/s/AKfycbywdq90H8X6CVYR2Vlla9rkRAPdsYmMTmO-sKfqsOmf7BGGNj0p_g4y/exec';
                                                const url = `${scriptUrl}?
                                                callback=ctrlq&action=${'doPostRepSite'}&week_number=${that.state.weekNumber}&auditor_name=${that.state.auditorsName}&job=${that.state.jobSelected}&house_number=${that.state.houseNumber}&row_number=${that.state.rowNumber}&worker_name=${that.state.workersName}&adi_code=${that.state.adiCode}&data1=${that.state.droppingOption1}&data2=${that.state.droppingOption2}&data3=${that.state.droppingOption3}&data4=${that.state.droppingOption4}&data5=${''}&data6=${''}&data7=${''}&data8=${''}&comments=${that.state.comments}&quality_percent=${that.state.qualityPercentage}`;
    ...
    navigateToScreen = () => {
        ...
        this.props.navigation.navigate('NameJobSelectorRep', { name: this.state.auditorsName })
